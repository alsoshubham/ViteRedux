...
const  App = () => {
  ...
  return (
    ...
    <div className="flex flex-col justify-center items-center">
      ...
      <h2 className="text-black text-2xl">counter value: {counter}</h2>
      <div className="p-10 mt-10 gap-5">
      <button 
      className="bg-blue-400 hover:bg-violet-400 text-white font-bold py-2 px-4 rounded" onClick={addValue}>Increment</button>
